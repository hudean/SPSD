...
namespace TestConsole
{
    public struct Board
    {
        public int num_up;        // 上复合板层数
        public int num_under;     // 下复合板层数
        public double h_up;       // 上复合板厚度
        public double h_under;    // 下复合板厚度
        public double l;          // 复合板横向长
        public double w;          // 复合板纵向长
    }

    public struct Fwcell
    {
        public double r_in_up;        // 胞元内六角上边界边长r
        public double r_out_up;       // 胞元外六角上边界边长rw
        public double r_in_under;     // 胞元内六角下边界边长R
        public double r_out_under;    // 胞元外六角下边界边长Rw

        public double Tn;             // 胞元厚度dc

        public double He;             // 胞元高度hc

        public int num_heng;          // 横向胞元数
        public int num_zong;          // 纵向胞元数
    }
    ...
    {
        public static void CreateTgFile()
        {
            // 定义蜂窝结构参数类型
            ...
            string fileName = @"C:\Users\mw\Desktop\test\mytgTest.tg";
            ...
            using (StreamWriter tgFile = new StreamWriter(fileName))
            {
                //上层复合板
